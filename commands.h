...
typedef enum {CMD_NONE, CMD_UNKNOWN, CMD_LS, CMD_LLS, CMD_CD, CMD_LCD, CMD_MKDIR, CMD_LMKDIR, CMD_RMDIR, CMD_LRMDIR, CMD_PWD, CMD_LPWD, CMD_GET, CMD_PUT, CMD_MGET, CMD_MPUT, CMD_SHOW, CMD_LSHOW, CMD_SHARE, CMD_DEL, CMD_LDEL, CMD_RENAME, CMD_LRENAME, CMD_COPY, CMD_LCOPY, CMD_LINK, CMD_LLINK, CMD_CHMOD, CMD_LCHMOD, CMD_CHEXT, CMD_LCHEXT, CMD_CRC, CMD_LCRC, CMD_MD5, CMD_LMD5, CMD_SHA1, CMD_LSHA1, CMD_SHA256, CMD_LSHA256, CMD_INFO, CMD_DISK_FREE, CMD_EXISTS, CMD_LEXISTS, CMD_STAT, CMD_LSTAT, CMD_LOCK, CMD_LLOCK, CMD_UNLOCK, CMD_LUNLOCK, CMD_CHPASSWORD, CMD_DIFF, CMD_CMP, CMD_HCMP, CMD_SET, CMD_HELP, CMD_QUIT} TCmds;

#define CMD_FLAG_ALL             1
#define CMD_FLAG_LONG            2
#define CMD_FLAG_THUMB           2
#define CMD_FLAG_LONG_LONG       4
#define CMD_FLAG_INTEGRITY       4
...
#define CMD_FLAG_OLDER        1024
#define CMD_FLAG_NEWER        2048
