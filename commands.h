...
typedef enum {CMD_NONE, CMD_LS, CMD_LLS, CMD_CD, CMD_LCD, CMD_MKDIR, CMD_LMKDIR, CMD_RMDIR, CMD_LRMDIR, CMD_PWD, CMD_LPWD, CMD_GET, CMD_PUT, CMD_MGET, CMD_MPUT, CMD_SHOW, CMD_LSHOW, CMD_SHARE, CMD_DEL, CMD_LDEL, CMD_RENAME, CMD_LRENAME, CMD_COPY, CMD_LCOPY, CMD_CHMOD, CMD_LCHMOD, CMD_CHEXT, CMD_LCHEXT, CMD_CRC, CMD_LCRC, CMD_MD5, CMD_LMD5, CMD_SHA1, CMD_LSHA1, CMD_SHA256, CMD_LSHA256, CMD_INFO, CMD_EXISTS, CMD_LEXISTS, CMD_STAT, CMD_LSTAT, CMD_LOCK, CMD_LLOCK, CMD_UNLOCK, CMD_LUNLOCK, CMD_CHPASSWORD, CMD_SET, CMD_HELP, CMD_QUIT} TCmds;
